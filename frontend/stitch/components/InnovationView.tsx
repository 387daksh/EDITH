...
import { getRiskRadar, RiskReport, getRole } from '../services/edith';
                        ...
                        {data.report.sort((a,b) => b.risk_score - a.risk_score).map((item, i) => (
                            ...
                            >
                                ...
                                <div className="flex justify-between items-start mb-2 relative z-10">
                                    <h4 className="font-bold text-gray-200 text-sm">{item.module}</h4>
                                    <div className={`w-2 h-2 rounded-full ${item.risk_label === 'CRITICAL' ? 'bg-red-500 animate-pulse' : item.risk_label === 'WARNING' ? 'bg-amber-500' : 'bg-emerald-500'}`}></div>
                                </div>
                                ...
                                <div className="flex items-center gap-3 mb-3 relative z-10">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs font-bold text-emerald-100">{item.owner.name}</p>
                                    </div>
                                </div>
